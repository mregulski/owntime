...
public interface DataProvider { 
    ...
    * elementary Connection should be added for ex. For Next 24 hours period. Then during each update new connections should be
    ...
    * Times of departure and arrival are update in coresponding connections. Ex. Real data prediction alg. predicts new arrival 
    * time and new Connection with specific id and updated times will be passed 
