 ...
 * Mamy dwie listy działające na zasadzie stosów:
 *  - requestList - lista aktualnych requestów
 *  - pathList - lista aktualnych wyników
 *  Każdy getter ściąga ze stosu.
 *  Wstawiłem synchrony dla pewności, że jakieś wątki się nie popitolą.
 */
